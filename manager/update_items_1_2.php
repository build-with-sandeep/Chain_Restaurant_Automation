...
<head>
	...
	<body>
		<header>
				<h1><span></span>Update Items</h1>
            </header>  
<body>
	<form action="update_items_1_2.php" method="post">
...
<?php
	...
	if( isset($_POST['search'])){
		...
		echo'</thead>';
	        ...
	        echo'<td><a style="color:red;" href="update_items.php?name='.$row[item_name].'&id='.$row[item_id].'&it='.$row[item_type].'">UPDATE</a></td>';
	    }
		echo'</tbody>';
	    echo'</table>';
		  	}
